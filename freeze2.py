...
# 基本设定，暴击，冻结暴击，施法时间，冰指和冰智概率（点冰冻之触）
critical = 1/3
...
while damage < 100000000000:
    ...
    if fingersOfFrost_number > 0 and brainFreeze_number == 0:
        time = time + gcd
        damage = damage + iceLance_basic_damage_fingersOfFrost_expectation
    ...
    # 之前触发了冰智，没有触发冰指，正常1+1+2
        ...
        damage = damage + iceStorm_damage_brainFreeze_expectation + iceLance_basic_damage_fingersOfFrost_expectation * 2
        brainFreeze_number = 0
    ...
    if fingersOfFrost_number > 0 and brainFreeze_number == 0:
        ...
        # 刚读完的寒冰箭触发了冰智，没触发冰指，扔完之前冰指对应的冰枪，打这个冰智的冰风暴+2冰枪
            ...
            damage = damage + iceStorm_damage_brainFreeze_expectation + \
                     iceLance_basic_damage_fingersOfFrost_expectation * 2
            brainFreeze_number = 0
